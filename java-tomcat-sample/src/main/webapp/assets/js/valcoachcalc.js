function calc(){
    ...
    var ferroPrata = "Aulas com professor Imortal 1 ou de elo superior. Abordamos: principais heróis de cada rota, builds, builds situacionais, fase de rotas, talentos, páginas de runas, utilização do mapa e farm.";
